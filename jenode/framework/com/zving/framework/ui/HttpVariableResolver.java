...
public class HttpVariableResolver implements IVariableResolver {
	protected HttpServletRequest request;
	protected AbstractTag currentTag;
	protected Mapx<String, Object> allMap = new CaseIgnoreMapx();

	public static HttpVariableResolver getInstance(AbstractTag tag,
	...
	public Object resolveVariable(String holder) {
		...
		if ("List".equalsIgnoreCase(holder)) {
			if (this.currentTag != null)
				...
				&& ("Parent".equalsIgnoreCase(holder))) {
	...
	protected Object getBeanProperty(Object bean, String property) {
		try {
			...
			BeanProperty p=null;
			if (v == null) {
				p = BeanManager.getBeanDescription(bean.getClass())
