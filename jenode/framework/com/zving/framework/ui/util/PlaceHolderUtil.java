...
public class PlaceHolderUtil
{
  ...
  public static String replacePlaceHolder(String html, AbstractExecuteContext context, boolean blankFlag, boolean spaceFlag) throws ExpressionException
  {
  ...
  public static String replacePlaceHolder(String html, IVariableResolver data, boolean blankFlag, boolean spaceFlag) throws ExpressionException {
  ...
  public static String replaceWithDataTable(String html, DataTable dt, boolean blankFlag, boolean spaceFlag) throws ExpressionException {
    ...
    for (Iterator localIterator1 = dt.iterator(); localIterator1.hasNext(); 
      localIterator2.hasNext())
    {
      DataRow dr = (DataRow)localIterator1.next();
      vr.setData(dr);
      localIterator2 = list.iterator(); continue; PlaceHolder p = (PlaceHolder)localIterator2.next();
      if (p.isString) {
        sb.append(p.Value);
      }
      if (p.isExpression) {
