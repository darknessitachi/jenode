...
public class FieldNode extends FieldVisitor {
	...
	public FieldNode(int access, String name, String desc, String signature,
			Object value) {
		this(262144, access, name, desc, signature, value);
	}

	public FieldNode(int api, int access, String name, String desc,
	...
	public void accept(ClassVisitor cv) {
		FieldVisitor fv = cv.visitField(this.access, this.name, this.desc,
