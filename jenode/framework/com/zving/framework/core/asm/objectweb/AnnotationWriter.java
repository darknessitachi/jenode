...
final class AnnotationWriter extends AnnotationVisitor {
	...
	AnnotationWriter(ClassWriter cw, boolean named, ByteVector bv,
			ByteVector parent, int offset) {
		super(262144);
		this.cw = cw;
		this.named = named;
		this.bv = bv;
	...
	public void visit(String name, Object value) {
		...
		if ((value instanceof String)) {
			...
			this.bv.put12(91, v.length);
			for (int i = 0; i < v.length; i++)
				this.bv.put12(90, this.cw.newInteger(v[i] != false ? 1 : 0).index);
		} else if ((value instanceof short[])) {
			short[] v = (short[]) value;
			this.bv.put12(91, v.length);
			for (int i = 0; i < v.length; i++)
	...
	public void visitEnum(String name, String desc, String value) {
		...
		this.bv.put12(101, this.cw.newUTF8(desc)).putShort(
				this.cw.newUTF8(value));
	}
	...
	public AnnotationVisitor visitAnnotation(String name, String desc) {
		...
		return new AnnotationWriter(this.cw, true, this.bv, this.bv,
				this.bv.length - 2);
	}
	...
	public AnnotationVisitor visitArray(String name) {
		...
		this.bv.put12(91, 0);
		return new AnnotationWriter(this.cw, false, this.bv, this.bv,
				this.bv.length - 2);
	}
