...
{
  private static Mapx<String, String> specialFamilyNames = new Mapx();
  private static String[][] all;
  private static Mapx<String, Integer> spellMap;
  ...
  static
  {
    ...
    all = new String[][] { 
      { "A", "啊阿呵吖嗄腌锕錒" }, 
      { "Ai", "爱矮挨哎碍癌艾唉哀蔼隘埃皑呆嗌嫒瑷暧捱砹嗳锿霭乂乃伌僾儗凒剀剴叆呃呝啀嘊噫噯堨塧壒奇娭娾嬡嵦愛懓懝敱敳昹曖欬欸毐溰溾濭烠焥璦皚皧瞹硋磑礙絠薆藹諰譪譺賹躷醷鎄鑀閡阂阨阸隑靄靉餲馤騃鯦鱫鴱" }, 
      ...
      { "Chen", "趁称辰臣尘晨沉陈衬橙忱郴榇抻碜谶宸龀嗔伧琛侲傖儭嚫堪塡填塵墋夦帘愖捵揨敐曟枕桭棧棽樄櫬沈谌湛瀋烥煁疢疹瘎瘨眈瞋硶磣稱綝縝缜肜胂茞莀莐蔯薼螴襯訦諃諶謓謲讖賝贂趂趻跈踸軙迧醦鈂鍖闖闯陳霃鷐麎齓齔秤" }, 
      { "Cheng", 
      ...
      { "Du", "读度毒渡堵独肚镀赌睹杜督都犊妒顿蠹笃嘟渎椟牍黩髑芏儥凟剢剫匵厾噣土塗妬嬻宅帾斁晵暏樚樞橐櫝殬殰涜瀆牘犢獨琽瓄皾睪秺竇笁篤纛荰蝳螙蠧裻襡襩覩詫読讀讟诧豄賭贕醏錖鍍鍺鑟锗闍阇陼靯韇韣韥頓騳黷" }, 
      ...
      { "Gao", "高搞告稿膏篙羔糕镐皋郜诰杲缟睾槔锆槁藁勂吿咎夰峼暠槀槹橰檺櫜滜澔獋獔皐睪祮祰禞稁稾筶縞羙臯菒蒿藳誥鋯鎬韟餻髙鷎鷱鼛" }, 
      { "Ge", 
      ...
      { "Zuan", "钻纂赚缵躜攥劗揝撮攒攢欑篹籫繤纉纘賺躦鑚鑽" }, { "Zui", "最嘴醉罪堆咀觜蕞厜嗺噿嫢嶉嶊嶵摧撮晬朘枠栬槯樶檇檌欈濢璻睟祽稡穝絊纗羧脧蟕辠酔酨酻鋷錊雋" }, 
  ...
  private static String getSpellByGBKCode(int code)
  {
    ...
    for (Entry e : spellMap.entrySet()) {
      int asciiRang = ((Integer)e.getValue()).intValue();
      if ((code >= asciiRang0) && (code < asciiRang)) {
        return spell0 == null ? (String)e.getKey() : spell0;
      }
      spell0 = (String)e.getKey();
  ...
  public static String getPersonNameSpelling(String str)
  {
    ...
    String v = (String)specialFamilyNames.get(first);
    if (v != null) {
      return v;
    }
