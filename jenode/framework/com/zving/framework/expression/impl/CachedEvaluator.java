  ...
  implements IEvaluator
{
  ...
  public IExpression parseExpression(String expression, Class<?> expectedType, IFunctionMapper fMapper)
    throws ExpressionException
  {
    ...
    throws ExpressionException
  {
    ...
    Object ret = this.mBypassCache ? null : cachedExpressionStrings.get(pExpressionString);
  ...
  private class JSTLExpression implements IExpression {
    ...
    public JSTLExpression(String evaluator, Class<?> expression, IFunctionMapper expectedType) { this.evaluator = evaluator;
      this.expression = expression;
      this.expectedType = expectedType;
      this.fMapper = fMapper; }

    public Object evaluate(IVariableResolver vResolver) throws ExpressionException
    {
