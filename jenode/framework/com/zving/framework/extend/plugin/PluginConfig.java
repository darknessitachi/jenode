...
public class PluginConfig
{
  ...
  public void parse(String xml) throws PluginException {
    ...
    this.resourceAsJar = Boolean.parseBoolean(root.elementText("resourceAsJar"));
    ...
    if (ObjectUtil.notEmpty(nds)) {
      for (XMLElement nd : nds) {
        this.requiredPlugins.put(nd.getText(), (String)nd.getAttributes().get("version"));
      }
