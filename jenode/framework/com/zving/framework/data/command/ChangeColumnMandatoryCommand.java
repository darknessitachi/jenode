...
public class ChangeColumnMandatoryCommand
  implements IDBCommand
{
  ...
  public void parse(String ddl) {
    ddl = ddl.substring("ChangeColumnMandatory:".length());
  ...
  public String toJSON() {
    ...
    return "ChangeColumnMandatory:" + JSON.toJSONString(map);
  }
}