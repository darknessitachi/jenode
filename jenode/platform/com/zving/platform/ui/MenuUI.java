...
public class MenuUI extends UIFacade
{
  ...
  public void del()
  {
    ...
    for (String id : arr) {
      ...
      if (pc == null) {
        ...
        StringFormat sf = new StringFormat(Lang.get("Platform.Menu.MenudeleteFailed"), new Object[] { m.getID() });
  ...
  public void init() {
    ...
    if (parent != null) {
      $S("ParentName", MenuManager.getMenu(m.getParentID()).getName(User.getLanguage()));
    }
  ...
  public void sortMenu() {
    ...
    DataTable dt = MenuPrivService.getAllMenus();
    DataTable dt2 = dt.filter(new Filter()
    {
