...
public class MetadataCheckboxColumn
  ...
  public String getHtml(ZDMetaColumn mc, String value)
  {
    ...
    if (StringUtil.isNotEmpty(options)) {
      ...
      for (String key : map.keySet()) {
        ...
        sb.append("<input type=\"checkbox\" id=\"" + code + "_" + i + "\" value=\"" + key + "\" name=\"" + code + 
          "\" " + checked + (YesOrNo.isYes(mc.getMandatoryFlag()) ? "verify=\"NotNull\"" : "") + "/>\n");
